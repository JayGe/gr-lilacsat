...
class MyForm(QtGui.QMainWindow):
    ...
    def StartGNURadio(self):
        if os.fork() == 0:
            ...
            os.execvp("gnuradio-companion", ("gnuradio-companion","gr-lilacsat/examples/Taurus-1/frontend_taurus1_rx_rtl.grc", "gr-lilacsat/examples/Taurus-1/frontend_taurus1_rx_fcdpp.grc", "gr-lilacsat/examples/Taurus-1/demod_taurus-1.grc"))
